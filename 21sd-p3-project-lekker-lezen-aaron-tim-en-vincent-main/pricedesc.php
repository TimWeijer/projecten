...
<body>
    ...
    // function die alle prijzen uit de database van hoog naar laag sorteert
    $statement = $conn->prepare("SELECT auteur, naam, uitgever, genre, foto, prijs, genre FROM boekeninfo ORDER BY prijs DESC");
    $statement->execute();
    ...
    <!-- haalt alle boeken op en laat ze zien in pre styled divs -->
    <?php
